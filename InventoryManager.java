...
public class InventoryManager
{
    ...
    public InventoryManager()
    {
        ...
        products.add(new Weapon("Sword", "Sharp steel sword", 50.0, 5, 25));
        products.add(new Weapon("Bow", "Long range weapon", 45.0, 4, 20));

        products.add(new Armor("Shield", "Strong defensive shield", 40.0, 3, 15));
        products.add(new Armor("Iron Armor", "Heavy body armor", 75.0, 2, 30));

        products.add(new Health("Health Potion", "Restores health", 10.0, 10, 50));
    }
